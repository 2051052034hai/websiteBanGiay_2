...
{
    public class QuanLySanPham_62133508Controller : BaseAdmin_62133508Controller
    {
        //
        // GET: /Admin/QuanLySanPham_62133508/
        ...
        public ActionResult ThemSanPham(SANPHAM sp, string cogiay_soluong)
        {
            ...
            return RedirectToAction("ChoDuyet", "QuanLySanPham_62133508");
        }
