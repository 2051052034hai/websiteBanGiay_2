...
{
    public class QuanLyDonHang_62133508Controller : BaseAdmin_62133508Controller
    {
        //
        // GET: /Admin/QuanLyDonHang_62133508/
        ...
        public ActionResult XuatDonHang(long id)
        {
            ...
            return RedirectToAction("DonHangDaXuat", "QuanLyDonHang_62133508");
        }
        ...
        public ActionResult TraDonHang(long id)
        {
            ...
            return RedirectToAction("Index", "QuanLyDonHang_62133508");
        }
        ...
        public ActionResult HoanThanhDonHang(long id)
        {
            ...
            return RedirectToAction("DonHangHoanThanh", "QuanLyDonHang_62133508");
        }
        ...
        public ActionResult HuyDonHang(long id)
        {
            var dao = new DonHangDAO();
            dao.HuyDonHang(id);
            return RedirectToAction("DonHangDaHuy", "QuanLyDonHang_62133508");
        }
