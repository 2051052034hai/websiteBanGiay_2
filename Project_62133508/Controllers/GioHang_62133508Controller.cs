...
using Project_62133508.Models;

namespace Project_62133508.Controllers
{
    public class GioHang_62133508Controller : Controller
    {
        //


        // GET: /GioHang_62133508/
        ...
        public ActionResult AddToCart()
        {
            ...
            return RedirectToAction("Index", "GioHang_62133508");
        }
        ...
        public ActionResult ThongTinKhachHang(string txtName, string txtPhone, string txtAddress, string txtEmail)
        {
            ...
            return Redirect("/GioHang_62133508/XemLaiDonHang?idorder=" + idorder + "");
        }
